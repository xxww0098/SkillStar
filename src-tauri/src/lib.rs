...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_shared_channel_organizations,
            commands::list_shared_channels,
            commands::create_shared_channel,
            commands::resume_shared_channel,
            commands::list_existing_channel_repositories,
            commands::scan_existing_shared_channel,
            commands::confirm_existing_shared_channel,
            commands::cancel_existing_shared_channel_registration,
            commands::preview_shared_channel_publish,
            commands::publish_shared_channel,
            commands::cancel_shared_channel_publish,
            commands::list_shared_channel_membership,
            commands::invite_shared_channel_member,
            commands::revoke_shared_channel_member,
            commands::cancel_shared_channel_invitation,
            commands::resend_shared_channel_invitation,
            commands::list_shared_channel_invitation_inbox,
            commands::accept_shared_channel_invitation,
            commands::decline_shared_channel_invitation,
            commands::resume_accepted_shared_channel,
            commands::list_shared_channel_subscriptions,
            commands::review_shared_channel_subscription,
            commands::subscribe_shared_channel,
            commands::get_shared_channel_update_state,
            commands::check_shared_channel_update,
            commands::apply_shared_channel_update,
            commands::list_shared_channel_skill_rollback_targets,
            commands::rollback_shared_channel_skill,
            commands::resume_shared_channel_skill_following,
            commands::uninstall_removed_shared_channel_skill,
            commands::convert_removed_shared_channel_skill_to_local,
            commands::install_shared_channel_skill,
            commands::uninstall_revoked_shared_channel_skill,
            commands::convert_revoked_shared_channel_skill_to_local,
            ...
            commands::get_guide,
            commands::load_learning_progress,
            commands::save_learning_progress,
            commands::preview_practice_install,
            commands::preview_guide_draft,
            commands::create_guide_draft,
            commands::list_guide_drafts,
            ...
            commands::models_commands::bind_provider,
            commands::models_commands::unbind_provider,
            commands::models_commands::unbind_agent,
            commands::models_commands::update_binding_entry,
            commands::models_commands::update_binding_entry_settings,
            commands::models_commands::update_agent_settings,
            ...
            commands::usage_commands::reset_subscription_quota,
