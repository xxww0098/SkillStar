...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::models_commands::get_model_config_status,
            commands::models_commands::get_claude_model_config,
            commands::models_commands::save_claude_model_config,
            commands::models_commands::get_codex_model_config,
            commands::models_commands::save_codex_model_config,
            commands::oauth_commands::get_codex_auth,
            commands::oauth_commands::save_codex_auth,
            commands::oauth_commands::get_codex_auth_status,
            commands::oauth_commands::codex_oauth_start,
            commands::oauth_commands::codex_oauth_complete,
            commands::oauth_commands::codex_oauth_cancel,
            commands::oauth_commands::codex_oauth_submit_callback,
            commands::oauth_commands::gemini_oauth_start,
            commands::oauth_commands::gemini_oauth_complete,
            commands::oauth_commands::gemini_oauth_cancel,
            commands::oauth_commands::gemini_oauth_submit_callback,
            commands::oauth_commands::gemini_oauth_is_configured,
            commands::oauth_commands::list_codex_accounts,
            commands::oauth_commands::get_current_codex_account_id,
            commands::oauth_commands::switch_codex_account,
            commands::oauth_commands::delete_codex_account,
            commands::quota_commands::refresh_codex_quota,
            commands::quota_commands::refresh_all_codex_quotas,
            commands::oauth_commands::add_codex_api_key_account,
            commands::quota_commands::refresh_gemini_quota,
            commands::models_commands::get_opencode_model_config,
            commands::models_commands::save_opencode_model_config,
            commands::models_commands::set_claude_setting,
            commands::models_commands::set_codex_setting,
            commands::models_commands::set_opencode_setting,
            commands::quota_commands::test_model_endpoints,
            commands::models_commands::get_opencode_cli_models,
            commands::oauth_commands::get_opencode_auth_providers,
            commands::oauth_commands::add_opencode_auth_provider,
            commands::oauth_commands::remove_opencode_auth_provider,
            commands::models_commands::open_opencode_config_dir,
            commands::models_commands::open_opencode_auth_dir,
            commands::models_commands::get_model_providers,
            commands::models_commands::get_model_provider_presets,
            commands::models_commands::switch_model_provider,
            commands::models_commands::add_model_provider,
            commands::models_commands::update_model_provider,
            commands::models_commands::delete_model_provider,
            commands::models_commands::reorder_model_providers,
            commands::models_commands::fetch_endpoint_models,
            commands::models_commands::read_model_config_text,
            commands::models_commands::write_model_config_text,
            commands::models_commands::format_model_config_text,
            commands::models_commands::get_provider_health_dashboard,
            commands::models_commands::refresh_provider_health_dashboard,
            commands::quota_commands::get_provider_usage_tracker,
            commands::quota_commands::get_provider_usage_summary,
            commands::models_commands::export_model_cloud_sync_snapshot,
            commands::models_commands::import_model_cloud_sync_snapshot,
