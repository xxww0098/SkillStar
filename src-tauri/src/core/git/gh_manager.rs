...
use crate::core::{lockfile, path_env::command_with_path};
...
fn get_publish_cache_dir(repo_name: &str) -> PathBuf {
    crate::core::infra::paths::publish_cache_dir(repo_name)
}
...
pub fn publish_skill(
    ...
    let skill_source_resolved = if crate::core::infra::fs_ops::is_link(&skill_source) {
