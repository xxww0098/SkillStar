...
//!
//! Call `migrate_legacy_paths()` once at app startup. The function is
//! idempotent — only moves files that still exist at old locations and
//! don't yet exist at new locations.
