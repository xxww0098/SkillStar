...
| 共享频道订阅选择与发布目标 | `~/.skillstar/config/shared_channel_subscriptions.json` | `skillstar-skills::shared_channels`；只保存 repository ID、release target、所选 Skill 与安装 baseline/provenance，不保存 GitHub 凭据 |
