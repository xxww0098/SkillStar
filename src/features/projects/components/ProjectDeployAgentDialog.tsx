...
import { Check, ChevronRight, FolderKanban, Layers3, Rocket, Sparkles, X } from "lucide-react";
...
export function ProjectDeployAgentDialog({
  ...
  const [selectedAgentIds, setSelectedAgentIds] = useState<string[]>(normalizedInitialSelection);
  ...
  return (
    <ModalShell
      ...
      onClose={onClose}
      ariaLabel={t("projectDeployDialog.title")}
      variant="subtle"
      panelClassName="max-w-[640px] p-4"
    >
      {/* ─── Header ────────────────────────────────────────────────────── */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold tracking-tight text-foreground flex items-center gap-2">
              ...
              <Badge
                variant="outline"
                className="h-[18px] px-1.5 text-micro uppercase tracking-widest font-bold bg-primary/10 text-primary border-primary/20 rounded-full"
              >
        ...
        <div>
          <div className="flex items-end justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              <Badge
                variant="outline"
                className="h-5 px-2 text-micro font-semibold bg-primary/5 text-primary border-primary/20 rounded-full"
              >
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1 relative z-10 flex flex-col justify-center">
                      <div className="flex items-center gap-2 mb-0.5">
                        <span
                          className={cn(
                            "truncate text-caption font-bold transition-colors",
