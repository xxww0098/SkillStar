...
export function AgentDisambiguationDialog({
  ...
  return (
    <ModalShell
      open={open}
      onClose={onClose}
      ariaLabel={t("projects.disambiguateTitle")}
      variant="subtle"
      panelClassName="max-w-[440px] p-4"
    >
      {/* Header */}
      <div className="flex items-center justify-between border-b border-border-subtle bg-card/70 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold tracking-tight text-foreground">{t("projects.disambiguateTitle")}</h2>
      ...
      {/* Candidates */}
      <div role="radiogroup" aria-label={t("projects.disambiguateTitle")} className="px-6 pt-2 pb-4 space-y-2">
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1 relative z-10">
                <span
                  className={cn("text-sm font-bold transition-colors", isSelected ? "text-primary" : "text-foreground")}
                >
