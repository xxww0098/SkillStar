            ...
            <div className="ss-page-scroll border-r border-border/40 px-4 py-4">
              ...
              <div className="space-y-2">
                {data.providers.map((provider) => {
                  ...
                  const agentHits = data.agents.filter((a) =>
                    bindsProvider(data.toolActivations[a.toolId], provider.id),
                  );
                  return (
                    <button
                      key={provider.id}
                    ...
                    >
                      <ProviderBrandIcon name={provider.name} size={32} />
    ...
    <div className="space-y-4">
      ...
      {focusProvider ? (
        <section className="rounded-xl border border-border/50 bg-card/40 p-3">
          <div className="flex items-center gap-2">
            <ProviderBrandIcon name={focusProvider.name} size={24} />
            ...
            <div className="mt-3 flex items-center gap-2">
              {agent.kind === "multi" || agent.toolId !== "claude-code" ? (
                <select
                  ...
                  defaultValue={entry?.provider_id === focusProvider.id ? entry.model : focusProvider.default_model || models[0]}
