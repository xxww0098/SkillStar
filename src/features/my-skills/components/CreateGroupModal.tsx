...
export function CreateGroupModal({
  ...
  return (
    <ModalShell
      open={isOpen}
      onClose={handleClose}
      ariaLabel={mode === "edit" ? t("createGroupModal.editGroup") : t("createGroupModal.newGroup")}
      panelClassName="max-w-lg"
    >
      {/* Header */}
      <ModalHeader
        title={mode === "edit" ? t("createGroupModal.editGroup") : t("createGroupModal.newGroup")}
        onClose={handleClose}
          ...
          <div className="relative flex items-end gap-3">
            ...
            <div className="flex-1 relative">
              <Input
                ...
                className={cn(
                  isDuplicateName && "border-destructive/80 focus-visible:ring-destructive/30 text-destructive",
                )}
              />
            </div>
          </div>
