import { Clock, Download, FolderTree, Package, Search, Share2 } from "lucide-react";
...
export function InputURLPhase({
  ...
  const hasAltSource = !!onPickLocalFile || !!onPickLocalFolder;
        ...
        <div className="space-y-3 pt-1">
          ...
          {onPickLocalFolder && (
            ...
            >
              ...
              {t("importModal.adoptFolder", { defaultValue: "Adopt from Local Folder" })}
            </Button>
          )}
        </div>
      )}
