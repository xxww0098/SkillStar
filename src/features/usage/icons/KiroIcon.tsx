/**
 * Kiro brand icon — `@lobehub/icons` 尚未收录 Kiro，按
 * https://lobehub.com/icons/skill.md 的 IconType 约定实现，便于日后与官方组件对齐。
 */
import type { IconType } from "@lobehub/icons";
import { memo } from "react";

const KiroIcon: IconType = memo(({ size = "1em", style, className, ...rest }) => (
  <svg
    height={size}
    width={size}
    viewBox="-2 -2 44 52"
