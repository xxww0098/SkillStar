...
const expandedTrack = cn(
  ...
  "dark:bg-muted/35 dark:ring-border/25",
);
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-primary/20 text-primary ring-1 ring-inset ring-primary/40 dark:bg-primary/25 shadow-xs"
      ...
      {modes.map((mode) => {
        ...
        return (
          ...
          >
            {isActive && (
              <motion.div
                ...
                className={cn(
                  ...
                  "dark:bg-card/95 dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] dark:ring-border/45",
                )}
                transition={
            ...
            <Icon
              className={cn(
                "relative z-10 h-4 w-4 shrink-0 transition-[color,transform] duration-200 group-hover:scale-110",
