  ...
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-xl border px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-[color,box-shadow,background-color] duration-150 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3",
  {
    variants: {
      variant: {
        ...
        hot: "bg-red-500/18 text-red-400 paper:text-red-700 border-red-500/30 shadow-2xs",
        popular: "bg-amber-500/18 text-amber-400 paper:text-amber-800 border-amber-500/30 shadow-2xs",
        rising: "bg-emerald-500/18 text-emerald-400 paper:text-emerald-700 border-emerald-500/30 shadow-2xs",
        new: "bg-violet-500/18 text-violet-400 paper:text-violet-700 border-violet-500/30 shadow-2xs",
        success: "bg-emerald-500/18 text-emerald-400 paper:text-emerald-700 border-emerald-500/30 shadow-2xs",
        warning: "bg-amber-500/18 text-amber-400 paper:text-amber-800 border-amber-500/30 shadow-2xs",
      },
    },
    defaultVariants: {
      variant: "default",
