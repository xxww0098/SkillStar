...
const badgeVariants = cva(
  "inline-flex items-center rounded-xl px-2.5 py-0.5 text-xs font-medium transition-all duration-200 backdrop-blur-sm border",
  {
    variants: {
      variant: {
        default: "bg-[#3b82f6]/15 text-[#3b82f6] border-[#3b82f6]/20",
