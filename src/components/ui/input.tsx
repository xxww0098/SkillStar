...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex h-9 w-full rounded-[9px] border border-input-border bg-input backdrop-blur-sm px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/70",
