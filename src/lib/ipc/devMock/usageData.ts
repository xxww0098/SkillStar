...
export const USAGE_CATALOG = [
  ...
  },
  {
    ...
    brand_color: "6C4DFF",
    default_currency: "USD",
    subscription_url: "https://www.codebuddy.ai",
    warning: null,
    regions: [],
  },
  {
    ...
    description: "CodeBuddy CN",
    tier: "o-auth",
    auth_modes: ["o-auth", "token-import"],
    brand_color: "6C4DFF",
    default_currency: "USD",
    subscription_url: "https://www.codebuddy.cn",
    warning: null,
    regions: [],
  },
  {
    ...
    brand_color: "12B886",
    default_currency: "USD",
    subscription_url: "https://www.trae.ai",
    warning:
      "没有浏览器登录。设备密钥和这次登录绑在一起，裸 refresh token 若被服务端校验设备会失败。请优先用本机导入读取 storage.json。",
    regions: [],
  },
  {
    id: "trae-solo",
    display_name: "TRAE SOLO",
    description: "TRAE SOLO",
    tier: "o-auth",
    auth_modes: ["o-auth", "token-import"],
    brand_color: "111827",
    default_currency: "USD",
  ...
  },
  {
    ...
    brand_color: "166534",
    default_currency: "USD",
    subscription_url: "https://www.trae.cn",
    warning:
      "没有浏览器登录。设备密钥和这次登录绑在一起，裸 refresh token 若被服务端校验设备会失败。请优先用本机导入读取 storage.json。",
    regions: [],
  },
...
export const USAGE_SUBSCRIPTIONS = [
  ...
  sub({
    ...
    auth_mode: "token-import",
    plan_tier: "Pro",
    monthly_price: 10,
    currency: "USD",
    sort_index: 3,
    usage: {
      subscription_id: "sub-github-copilot",
      fetched_at: nowSec() - 1200,
      plan_name: "Pro",
      hourly: null,
      weekly: null,
      monthly: {
