...
impl ChannelRemovedSkillHandler for GitChannelSubscriptionInstaller {
    async fn uninstall_and_commit(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            match crate::skill_install::uninstall_hub_skill_with_commit(&skill.id, || {
    ...
    async fn convert_to_local_and_commit(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            crate::local_skill::preserve_installed_copy(&skill.id, &local_name).map_err(
                |error| {
            ...
            match crate::skill_install::uninstall_hub_skill_with_commit(&skill.id, || {
                ...
                Err(failure) if failure.rollback_complete => {
                    let cleanup_error = crate::local_skill::delete(&local_name).err();
...
fn transaction_failure(
    failure: crate::skill_install::UninstallSkillFailure,
