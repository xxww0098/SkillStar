//! Reusable model configuration domain for SkillStar.
//!
//! Provider registry, health checks, quota, circuit-breaker, and per-app
//! config file helpers.  App-specific Tauri/OAuth wiring stays in the
