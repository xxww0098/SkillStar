...
pub(super) struct UpdateInstaller {
    ...
    pub(super) divergence_reasons:
        Arc<Mutex<BTreeMap<String, skillstar_skills::skill_update::LocalDivergenceReason>>>,
...
async fn explicit_local_resolution_allows_the_blocked_skill_to_advance() {
    ...
    let result = service(gateway, subscriptions, installer.clone())
        .apply_update(ApplyChannelUpdateRequest {
            ...
            resolutions: vec![ChannelSkillUpdateResolution {
                ...
                resolution: skillstar_skills::skill_update::LocalDivergenceResolution::Preserve {
    ...
    assert!(matches!(
        writer.resolution,
        Some(skillstar_skills::skill_update::LocalDivergenceResolution::Preserve { .. })
    ));
}
    ...
    let error = service(gateway, subscriptions, installer.clone())
        .apply_update(ApplyChannelUpdateRequest {
            ...
            resolutions: vec![ChannelSkillUpdateResolution {
                ...
                resolution: skillstar_skills::skill_update::LocalDivergenceResolution::Discard,
            }],
        })
        .await
        .unwrap_err();
