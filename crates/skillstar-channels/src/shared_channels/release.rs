...
pub const CHANNEL_CONTENT_HASH_VERSION: u32 = skillstar_skills::content::SNAPSHOT_HASH_VERSION;
...
fn valid_skill_id(value: &str) -> bool {
    value.len() <= 128 && skillstar_skills::content::validate_skill_name(value).is_ok()
}
