//! Migration property tests (v1 -> v2), moved in-crate when the v1 store
//! surface was contracted to `pub(crate)` (external test binaries can no
//! longer construct v1 stores).
//!
