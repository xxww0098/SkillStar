...
use crate::provider_env::extract_env_for_pane;
use crate::registry::binary_name_for_agent;
...
pub fn pane_command_spec(pane: &LayoutNode) -> Option<PaneCommandSpec> {
...
pub fn build_posix_pane_command(pane: &LayoutNode) -> String {
