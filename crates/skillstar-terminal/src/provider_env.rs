...
pub fn normalize_claude_model_env(env: &mut HashMap<String, String>) {
...
pub fn normalize_claude_auth_keys(env: &mut HashMap<String, String>) {
...
pub fn extract_env_for_pane(pane: &LayoutNode) -> HashMap<String, String> {
    ...
    let store = skillstar_model_config::providers::read_store().unwrap_or_default();
