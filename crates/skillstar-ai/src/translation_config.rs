//! Translation API configuration types.
//!
//! Moved from `translation_api::config` as part of the `skillstar-ai` extraction.
//! Orchestration (router, services, markdown) stays in `src-tauri` for T15.
