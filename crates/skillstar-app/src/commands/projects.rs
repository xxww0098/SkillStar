...
use skillstar_projects::projects::{project_manifest, sync};
...
pub async fn register_project(
    ...
    project_manifest::register_project(&project_path).map_err(|e| AppError::Other(e.to_string()))
}
...
pub async fn remove_project(name: String) -> Result<(), AppError> {
    project_manifest::remove_project(&name).map_err(|e| AppError::Other(e.to_string()))
}
...
pub async fn scan_project_skills(
    ...
    project_manifest::scan_project_skills(&project_path).map_err(|e| AppError::Other(e.to_string()))
}
